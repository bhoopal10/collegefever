...
if($task == "del")
{
	$sql =" delete from college where id = ".$_REQUEST['id'];
	mysql_query($sql);
}
else if($task == "edit")
{
		...
		<td >
			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="450px">
				<tr>
					...
					<h2>College</h2>
					<br /><a href="collegeedit.php?task=add"><img src="images/add_new.gif" border="0" alt="Add New Content" title="Add New Content" /></a><br />
					<br /></span>
					<?php 
					...
					<table width="100%" cellpadding="6" cellspacing="1" bgcolor="#CCCCCC" class="tablegrid" >
                      ...
                      <tr>
                        ...
                        <td align="left" bgcolor="#FFFFFF"><a href="collegeedit.php?id=<?php echo $row['id'];?>&amp;task=edit"> <img src="images/edit.png" border="0" alt="Edit" title="Edit" height="20px" width="20px"/> </a> <a href="college.php?task=del&amp;id=<?php echo $row['id'];?>"><img src="images/cross.png" width="24" height="24" /></a></td>
                      </tr>
                      <?php 	}?>
                    </table>
					<?php }else {
