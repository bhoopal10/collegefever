...
date_default_timezone_set('Asia/Calcutta');
	   ...
	   /* local connection */
        ...
        define("DB_NAME", "collegefever3");    // <-- mysql db pname
        define("DB_HOST", "localhost");*/

		/*define("DB_USER", "dlwdemon_college");              // <-- mysql db user
        define("DB_PASSWORD","Qb%()sV^Uh+A");         // <-- mysql db password
        define("DB_NAME", "dlwdemon_collegefever");    // <-- mysql db pname
        define("DB_HOST", "localhost");*/
		
		define("DB_USER", "root");              // <-- mysql db user
        define("DB_PASSWORD","");         // <-- mysql db password
        define("DB_NAME", "collegefever");    // <-- mysql db pname
        define("DB_HOST", "localhost");
