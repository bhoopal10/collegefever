...
if($task == "edit")
{
		$sql ="select * from category where id = ".$_SESSION['hmedid'];
		$result = mysql_query($sql);
		$ged2 = mysql_fetch_object($result);
		$_SESSION['rsvuser']=$ged2->username;
		$_SESSION['rsvicon']=$ged2->pic;
		$legend = "Edit Details";
		$btnval = "Save";
}
else
        ...
        <tr>
          ...
          <td width="80%" align="center"><br />
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="95%">
              <tr align="center">
                <td><fieldset>
                  <h2 align="left"><span style="padding-left:20px;">Category Dropdown </span></h2>
                  <legend><?php echo $legend;?></legend>
				  <table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#CCCCCC">
                      <tr></tr>
                      <tr>
                        <td bgcolor="#FFFFFF"><form method="post" action="category.php"  enctype="multipart/form-data" name="RegForm" id="RegForm" onSubmit="return CheckRegister();">
                          <table width="100%" border="0" cellpadding="3" cellspacing="3" style="padding-left:5px">
                            ...
                            <tr>
                              <td width="100%"><table width="100%" border="0" cellpadding="9" cellspacing="1" bgcolor="#FFFFFF">
                                  <tr>
                                    <td width="26%" bgcolor="#FFFFFF">Name</td>
                                  ...
                                  <tr>
                                    ...
                                    <td bgcolor="#FFFFFF" class="regform"><span class="second">
