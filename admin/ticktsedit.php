                            ...
                            <tr>
                              <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                                <tr>
                                  ...
                                  <td width="25%"><input name="tname<?php echo $it; ?>" type="text" id="tname<?php echo $it; ?>" placeholder="Ticket Name" /></td>
                                  <td width="25%"><span class="first">Price per ticket<span class="red-txt"> *</span> </span></td>
                                  <td width="25%"><input name="slprice<?php echo $it; ?>" type="text" id="slprice<?php echo $it; ?>" placeholder="Enter price in INR" value="<?php echo $getevdet->slprice; ?>" /></td>
                                </tr>
                                <tr>
                                  <td><span class="first"> Maximum Registrations <span class="red-txt">*</span></span></td>
                                  <td><select name="maxreg<?php echo $it; ?>" id="maxreg<?php echo $it; ?>">
                                  ...
                                  <td><select name="minorder<?php echo $it; ?>" id="minorder<?php echo $it; ?>">
                                      <option value="">Select</option>
                                      <?php for($i=1;$i<=100;$i++) { ?>
                                ...
                                <tr>
                                  ...
                                  <td><select name="maxorder<?php echo $it; ?>" id="maxorder<?php echo $it; ?>">
                                      <option value="">Select</option>
                                      <?php for($i=1;$i<=100;$i++) { ?>
