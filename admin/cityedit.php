...
if($task == "edit")
{
		$sql ="select * from city where id = ".$_SESSION['hmedid'];
        ...
        <tr>
          ...
          <td width="80%" align="center"><br />
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="95%">
              <tr align="center">
                <td><fieldset>
                  <h2 align="left"><span style="padding-left:20px;">City Dropdown </span></h2>
                  <legend><?php echo $legend;?></legend>
				  <table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#CCCCCC">
                      <tr></tr>
                      <tr>
                        <td bgcolor="#FFFFFF"><form method="post" action="city.php"  enctype="multipart/form-data" name="RegForm" id="RegForm" onSubmit="return CheckRegister();">
