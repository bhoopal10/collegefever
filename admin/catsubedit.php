...
if($task == "edit")
{
		$sql ="select * from catsub where id = ".$_SESSION['hmedid'];
        ...
        <tr>
          ...
          <td width="80%" align="center"><br />
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="95%">
              <tr align="center">
                <td><fieldset>
                  <h2 align="left"><span style="padding-left:20px;">Sub Category Dropdown </span></h2>
                  <legend><?php echo $legend;?></legend>
				  <table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#CCCCCC">
                      <tr></tr>
                      <tr>
                        <td bgcolor="#FFFFFF"><form method="post" action="catsub.php"  enctype="multipart/form-data" name="RegForm" id="RegForm" onSubmit="return CheckRegister();">
                          <table width="100%" border="0" cellpadding="3" cellspacing="3" style="padding-left:5px">

                            <tr>
                              <td width="100%"><table width="100%" border="0" cellpadding="9" cellspacing="1" bgcolor="#FFFFFF">
                                  <tr>
                                    <td bgcolor="#FFFFFF">Category</td>
                                    <td bgcolor="#FFFFFF" class="regform">
                                      <select name="category" id="category">
                                      <?php
									  $getcat=mysql_query("select * from category order by name asc");
									  while($getcat1=mysql_fetch_object($getcat))
									  {
										if($ged2->category==$getcat1->name)  
										{
									  		?><option value="<?php echo $getcat1->name ?>" selected="selected"><?php echo $getcat1->name ?></option><?php
										}
										else
										{
											?><option value="<?php echo $getcat1->name ?>"><?php echo $getcat1->name ?></option><?php
										}
									  }
									  ?>  
                                      </select>
                                  ...
                                  <tr>
                                    <td width="26%" bgcolor="#FFFFFF">Sub Category</td>
                                    <td width="74%" bgcolor="#FFFFFF" class="regform"><input name="name" type="text" id="name" value="<?php echo $ged2->name; ?>" />                                    </td>
                                  </tr>
                              </table></td>
                            </tr>
                            <tr>
